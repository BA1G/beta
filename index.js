...
const playSrcList = [
    "assets/naat-1-img.webp",
    "assets/naat-2-img.webp",
    "assets/naat-3-img.webp",
    "assets/naat-4-img.webp",
    "assets/naat-5-img.webp",
    "assets/naat-6-img.webp",
];
...
$(".recommendations-subdiv-1").on("click", function () {
    songIndex = 0;
    songs[songIndex].play();
    $(".player-page").css("display", "none");
    $(".play-page").css("display", "block");
...
$(".recommendations-subdiv-2").on("click", function () {
    songIndex = 1;
    songs[songIndex].play();
    $(".player-page").css("display", "none");
    $(".play-page").css("display", "block");
...
$(".recommendations-subdiv-3").on("click", function () {
    songIndex = 2;
    songs[songIndex].play();
    $(".player-page").css("display", "none");
    $(".play-page").css("display", "block");
...
$(".recommendations-subdiv-4").on("click", function () {
    songIndex = 5;
    songs[songIndex].play();
    $(".player-page").css("display", "none");
    $(".play-page").css("display", "block");
...
$(".play-pause-btn").on("click", function () {
    ...
    setTimeout(function () {
        $(".play-pause-btn").css(
            "background",
            "linear-gradient(rgba(94,70,248,1) 100%,rgba(192,62,254,1) 100% )"
        );
    }, 170);
});
...
$(document).ready(function () {
    if (window.location.pathname == "/index.html") {
        ...
        setTimeout(() => {
            $(".toast-index").addClass("show");
        }, 1000);
    }
});


$(".player-h6").on("click", function () {
    setTimeout(() => {
